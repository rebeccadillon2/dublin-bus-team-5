...
export function PageContainer(props) {
  ...
  const classes = `page-me flex flex-col items-center justify-start md:min-h-[calc(100vh-64px)] min-h-[calc(100vh)] w-100 transition-all ease-in-out duration-300 md:px-0 px-4 ${themeClasses}`;
