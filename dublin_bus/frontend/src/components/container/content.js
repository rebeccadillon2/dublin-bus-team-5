...
export function ContentContainer(props) {
  ...
  const innerClasses = `container-to-make py-2 md:px-4 px-4 md:w-100.1 transition-all ease-in-out duration-500 md:min-h-[calc(100vh-64px)] overflow-y-scroll ${themeClasses} ${
